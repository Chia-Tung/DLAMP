...
#PJM -L gpu-share=8                     # GPU Cards
#PJM -L elapse=72:00:00                 # elapse time
#PJM -o 'sys_log/zebra.%j.out'          # write log out to log directory
#PJM -e 'sys_log/zebra.%j.err'          # write error message to log directory
